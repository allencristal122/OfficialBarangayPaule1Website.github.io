...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt->bind_param("sssssss", $position, $photos, $full_Name, $contacts, $barangayaddress, $start_Of_Term, $end_Of_Term);
