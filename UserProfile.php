          ...
          <div class="info">
            <form class="form1">
                <?php
                    ...
                    $sql = "SELECT * FROM important_info";
                    $result = $conn->query($sql);
          ...
          <div class="form-group3">
              <div class="input-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="barangayResident" placeholder="Allergies or Medical Conditions" value="<?php echo $profileallergies_conditions; ?>">
                  </div>
              </div>
          </div>
          <div class="form-group3">
              <div class="input-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="barangayResident" placeholder="Education Attainment" value="<?php echo $profileeducation; ?>">
                  </div>
              </div>
          </div>
          <div class="form-group3">
