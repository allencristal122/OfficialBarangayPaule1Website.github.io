        ...
        <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="requirements" name="requirements" placeholder="Enter requirements">
                  </div>
                </div>
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <span class="input-group-text"><i class="bi bi-file-earmark-check"></i></span>
                        <input type="text" class="form-control" id="requirements" name="requirements" placeholder="Enter requirements" value="<?php echo $formrequirements; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="address" class="lab">File</label>
